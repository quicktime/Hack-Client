...
public class StatisticsManagerServer extends StatisticsManager
{
    ...
    public void unlockAchievement(EntityPlayer playerIn, StatBase statIn, int p_150873_3_)
    {
        ...
        if (statIn.isAchievement() && i == 0 && p_150873_3_ > 0)
        {
            ...
            {
                this.mcServer.getPlayerList().sendChatMsg(new TextComponentTranslation("chat.category.achievement", new Object[] {playerIn.getDisplayName(), statIn.createChatComponent()}));
            }
        }
        ...
        if (statIn.isAchievement() && i > 0 && p_150873_3_ == 0)
        {
            ...
            if (this.mcServer.isAnnouncingPlayerAchievements())
            {
                this.mcServer.getPlayerList().sendChatMsg(new TextComponentTranslation("chat.category.achievement.taken", new Object[] {playerIn.getDisplayName(), statIn.createChatComponent()}));
            }
        }
    }
