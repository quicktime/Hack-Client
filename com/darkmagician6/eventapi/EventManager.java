...
import at.tiam.bolt.module.IToggleable;
...
public final class EventManager {
	...
	/**
	 * All methods in this class are static so there would be no reason to create an object of the EventManagerOld class.
	 */
	private EventManager() {
	}
	
    /**
     * Registers all the methods marked with the EventTargetOld annotation in the class of the given Toggleable.
     *
     * @param toggleable
    ...
    /**
     * Registers the methods marked with the EventTargetOld annotation and that require
     * the specified EventOld as the parameter in the class of the given Toggleable.
     *
     * @param toggleable
    ...
    /**
     * Unregisters all the methods inside the Toggleable that are marked with the EventTargetOld annotation.
     *
     * @param toggleable
    ...
    /**
     * Sorts the List that matches the corresponding EventOld class based on priority value.
     *
     * @param indexClass
     *         The EventOld class index in the HashMap of the List to sort.
     */
     ...
     * Performed checks: Checks if the parameter length is not 1 and if the EventTargetOld annotation is not present.
     *
     * @param method
     *         Method to check.
     *
     ...
     *         Method to check.
     * @param Class
     *         of the EventOld we want to find a method for receiving it.
     *
     * @return True if the method should not be used for receiving event calls from the Dispatcher.
     *
     * @see com.darkmagician6.eventapi.EventTarget
     ...
     * If the EventOld was an instance of EventStoppable it will check every loop if the EventStoppable is stopped, and if
     * it is it will break the loop, thus stopping the call.
     * For every MethodData in the list it will invoke the Data's method with the EventOld as the argument.
     * After that is all done it will return the EventOld.
     *
     * @param event
     *         EventOld to dispatch.
     *
     * @return EventOld in the state after dispatching it.
     */
    ...
    /**
     * Invokes a MethodData when an EventOld call is made.
     *
     * @param data
     *         The data of which the targeted Method should be invoked.
     * @param argument
     *         The called EventOld which should be used as an argument for the targeted Method.
     *         
     * TODO: Error messages.
     */
	...
	private static final class MethodData {
	     ...
	     * @param target
	     *         The targeted Method to which the EventOld should be send to.
	     * @param priority
	     ...
	     *
	     * @return The Method that is listening to certain EventOld calls.
	     */
